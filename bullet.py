...
class Bullet(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        super().__init__()
        self.screen = ai_game.screen                          # przypisanie ekranu
        self.settings = ai_game.settings                      # przypisanie ustawien
        self.color = self.settings.bullet_color               # przypisanie koloru pocisku
