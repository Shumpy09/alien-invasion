class Settings():
    ...
    def __init__(self):
        ...
        self.bullets_allowed = 3            # ograniczenie ilości pocisków

        # Ustawienia dotyczące obcego
        self.fleet_drop_speed = 10          # prędkość poruszania się floty w dół

        # Łatwa zmiana szybkości gry
        self.speedup_scale = 1.1
        # Łatwa zmiana liczby punktów przyznawanych za zetrzelenie obcego
